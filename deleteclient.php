...
<form method="post" action="<?php print $_SERVER['PHP_SELF']?>">
	...
	<p>Insert the client ID to delete: <input type="text" name="read" />
...
if ( isset( $_POST['submit'] ) ) {
	...
	$query3 = "DELETE FROM client WHERE client_id= $ID";
...
<HTML><BODY><p><form method="post" action="<?php print $_SERVER['PHP_SELF']?>"></p></BODY></HTML>
	...
	<input name= "submit" type="submit" value="Delete" /></p></BODY></HTML>
