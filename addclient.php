<HTML><BODY><p><form method="post" action="<?php print $_SERVER['PHP_SELF']?>">
	
	
	Insert a new client ID to generate:<input type="text" name="read" />
	<input type="submit" value="GO" /></p></BODY></HTML>
<?php
	global $name;
	global $ID;
	global $address;
...
if ( isset(  $_POST['read'] ) AND $_POST['read']!= NULL ) 
{
	$ID= $_POST['read'];
	$query2 = "INSERT INTO client (client_id) VALUES ('$ID')";
	...
	$query1 = "SELECT * FROM client WHERE client_id = '$ID'";
